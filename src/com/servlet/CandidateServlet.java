...
public class CandidateServlet extends HttpServlet {
    ...
    private void addCandidate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (lastName.equals("") || firstName.equals("") || login.equals("") || password.equals("") || city.equals("") || partyName.equals("Sélectionnez un parti") || birthDate.equals("")) {
        ...
        if (inserted) {
            ...
            request.setAttribute("errorMessage", "L'enregistrement de votre compte voteur n'a pas réussi");
            RequestDispatcher dispatcher = request.getRequestDispatcher(option + "Candidate.jsp");
            dispatcher.forward(request, response);
        }
    }
